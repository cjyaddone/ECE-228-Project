...
class TrilineTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.movement_head = self._head(d_model, 4, dropout)
        distance_input_dim = d_model + 4 if self.use_movement_categories else d_model
        self.distance_head = self._head(distance_input_dim, 1, dropout)
